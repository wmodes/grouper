...
then
    ...
    command="python gatorgrouper_cli.py --file $file --num-group $numgroups --method graph --objective-measures $measure --objective-weights $weight --preferences $pref --preferences-weight $prefweight --preferences-weight-match $prefweightmatch"
fi
