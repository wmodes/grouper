...
class Grouper(object):
    ...
    def prep_data(self):
        for i in range(len(self.class_data)):
            ...
            # iterate over fields to massage values
            for key in self.class_data[i]:
                ...
                # if there is a text value (but no number) assign 1
                elif str != '':
                    self.class_data[i][key] = 1
                # if there is no value at all, assign 0
                elif str == '':
                    self.class_data[i][key] = 0
    ...
    def build_cl_opt(self):
        ...
        if (self.prefopt):
            ...
            print("Using preference file: ", cli_pref)
        else:
            cli_pref = ""
